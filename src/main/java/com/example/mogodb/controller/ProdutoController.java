...
import com.example.mogodb.model.Produto; // Importa o modelo Produto.
import com.example.mogodb.service.ProdutoService; // Importa o serviço ProdutoService para lógica de negócios.
